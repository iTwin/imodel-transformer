...
export namespace IModelHubUtils {
  ...
  export async function queryIModelId(
   ...
   */
  export async function queryChangesetId(
    accessToken: AccessToken,
    iModelId: GuidString,
   ...
   * @note This function should be removed when full support for ChangesetIndex is in place.
   */
  export async function queryChangesetIndex(
    accessToken: AccessToken,
    iModelId: GuidString,
  ...
  export async function forEachChangeset(
    accessToken: AccessToken,
    iModelId: GuidString,
  ...
  export async function forEachNamedVersion(
    accessToken: AccessToken,
    iModelId: GuidString,
    func: (v: NamedVersion) => void
  ): Promise<void> {
  ...
  export async function downloadAndOpenBriefcase(
    ...
    const cached = BriefcaseManager.getCachedBriefcases(
      briefcaseArg.iModelId
    ).find(
      (briefcase) =>
        briefcase.changeset.id === briefcaseArg.asOf?.afterChangeSetId
    );
