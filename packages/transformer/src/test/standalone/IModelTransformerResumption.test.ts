...
>({
  ...
  try {
    ...
    transformer = await TransformerClass.newResumeTransformation({ 
      statePath: dumpPath, initializeArgs: { accessToken: await HubWrappers.getAccessToken(TestUtils.TestUserType.Regular) } 
