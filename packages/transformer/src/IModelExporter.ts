...
export class IModelExporter {
   ...
   * @note It is guaranteed that exporter.sourceDbChanges will be defined and populated with the changesets passed to the transformer, if any, when this function is called by the transformer.
