...
import { assertSafeBenchmarkOutputPath } from "../BenchmarkRunner";
import { DatasetDescriptor } from "../DatasetDescriptor";
import { updateHeavyScanDescriptor } from "../FixtureCatalog";
import { canonicalSha256 } from "../FixtureManifest";
import { getFixtureProvider } from "../FixtureProvider";
import {
...
function smokeDescriptor(): DatasetDescriptor {
