...
Before you create a new issue, please do a search in [open issues](https://github.com/iTwin/imodel-transformer/issues) to see if the issue or feature request has already been filed.
...
- Impact of the issue
- Use the [`bug`](https://github.com/iTwin/imodel-transformer/labels/bug) or [`enhancement`](https://github.com/iTwin/imodel-transformer/labels/enhancement) label to identify the type of issue you are filing
