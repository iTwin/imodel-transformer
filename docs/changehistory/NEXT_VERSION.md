...
If you relied on the previous default behavior to detach a cache after transformation, detach it explicitly through the API that attached it or close the source database when finished.
